...
export default function User() {
  return (
    ...
    <div className={styles.container}>
      <Head>
        <title>研修</title>
        <meta name="description" content="研修申請" />
      ...
      <div className={styles.point_detail}>
        ...
        <div className={styles.detail}>
          <h3 className='font-bold'>受講可能コース一覧</h3>
      ...
      <div className={styles.use_point}>
        <h2 className="font-bold text-xl">研修日とコースを申請する</h2>
        ...
        <div className={styles.history_detail}>
        <h3 className='font-bold'>受講履歴</h3>
        <div className={styles.history_detail_items}>
          <p>2022/10/30 皆勤賞 5pt</p>
          <p>2022/11/30 皆勤賞 5pt</p>
          <p>2022/10/30 皆勤賞 5pt</p>
          <p>2022/11/30 皆勤賞 5pt</p>
